...
/**
 * API 응답을 자동으로 ApiRes로 감싸주는 Advice
 */
...
public class ApiResponseAdvice implements ResponseBodyAdvice<Object> {
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType,
        ...
        if (body == null || returnType.getParameterType() == Void.class) {
            return ApiRes.success(MemberSuccessCode.SUCCESS);
        }
        
        // 일반 데이터인 경우 성공 응답으로 감싸기
        return ApiRes.success(MemberSuccessCode.SUCCESS, body);
    }
}